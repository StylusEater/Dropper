...
## Use showAllSizes.php and showAllImages.php to help with parameters.
##  
## This example generates a new 512MB droplet in the Amsterdam region with Debian x86-64 as
## the base. 
$dropper->newDroplet("foo.com",12573,2,66,1);
